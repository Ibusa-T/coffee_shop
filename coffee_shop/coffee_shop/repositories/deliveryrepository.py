...
class DeliveryRepository(Baserepository):
    ...
    @classmethod
    def findByDeliveryDate(deliveryDate):
        return cls.master_factory.get_model(cls.name).objects.filter(deliveryDate=deliveryDate)

    @classmethod
    def findByDeliveryStatus(deliveryStatus):
        return cls.master_factory.get_model(cls.name).objects.filter(deliveryStatus=deliveryStatus)
